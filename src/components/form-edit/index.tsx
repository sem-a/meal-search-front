...
import { useEditRecipeMutation } from "../../app/services/recipes";
...
export const FormEdit: React.FC<Props> = ({ recipe }) => {
  const [update] = useEditRecipeMutation();
  ...
  const [name, setName] = useState<string>(recipe?.title || "");
